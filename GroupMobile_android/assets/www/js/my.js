...
/**
 * Sends POST /login to API gateway.
 * 
 * This method is automatically generated. Don't modify it.
 * Application logic for handling the AJAX response should 
 * be placed in <code>onPostLogin</code>.
 */ 
function postLogin() {
	// This method is automatically generated. Don't modify it.
	jQuery.mobile.showPageLoadingMsg('Loading');
	$.ajax({
		...
		data : {
			...
			'groupname' : $('#textinput2').val(),
			'password' : $('#textinput3').val(),
		}, 
		success : function(data, status, xhr) {
			jQuery.mobile.hidePageLoadingMsg();
			onPostLogin(data);
...
/**
 * Handle AJAX response for POST /login
 * 
...
$(document).ready(function () {
	$('#button21').bind('click', getLogout);
	$('#button12').bind('click', getUpload);
	$('#button15').bind('click', getLogout);

	$('#button13').bind('click', postLogin);
});

/**
 * Sends GET /logout to API gateway.
 * 
 * This method is automatically generated. Don't modify it.
 * Application logic for handling the AJAX response should 
 * be placed in <code>onGetLogout</code>.
 */ 
function getLogout() {
	// This method is automatically generated. Don't modify it.
	jQuery.mobile.showPageLoadingMsg('Loading');
	$.ajax({
		url : gatewayURL + '/logout',
		cache : false,
		type: 'GET', 
		data : {
			'logout' : id,
...
/**
 * Handle AJAX response for GET /logout
 * 
 * @param response JSON object with response
 */
function onGetLogout(response) {
	// TODO Custom logic to handle server response
}

/**
 * Sends GET /upload to API gateway.
 * 
 * This method is automatically generated. Don't modify it.
 * Application logic for handling the AJAX response should 
 * be placed in <code>onGetUpload</code>.
 */ 
function getUpload() {
	// This method is automatically generated. Don't modify it.
	jQuery.mobile.showPageLoadingMsg('Loading');
	$.ajax({
		url : gatewayURL + '/upload',
		cache : false,
		type: 'GET', 
		data : {
			'uploadtext' : $('#textinput6').val(),
		}, 
		success : function(data, status, xhr) {
			jQuery.mobile.hidePageLoadingMsg();
			onGetUpload(data);
...
/**
 * Handle AJAX response for GET /upload
 * 
 * @param response JSON object with response
 */
function onGetUpload(response) {
	// TODO Custom logic to handle server response
}